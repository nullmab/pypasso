...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      { name: "description", content: "Python, un passo alla volta: lezioni, quiz e laboratori per la scuola superiore." },
      { name: "theme-color", content: "#0E5C4A" },
    ],
    links: [
